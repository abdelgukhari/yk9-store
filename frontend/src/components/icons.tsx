...
export function PyramidIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      <circle cx="18.5" cy="5.5" r="2" fill="currentColor" opacity="0.55" />
      <path d="M12 3 22 20H2Z" fill="currentColor" />
      <path d="M12 3 16.2 20H7.8Z" fill="currentColor" opacity="0.35" />
      <path d="M8.6 13.5h6.8" stroke="currentColor" strokeOpacity="0.4" strokeWidth="0.6" />
    </svg>
  );
}